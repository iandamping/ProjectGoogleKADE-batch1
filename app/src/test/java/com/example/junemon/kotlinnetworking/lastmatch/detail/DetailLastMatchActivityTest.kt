...
import com.example.junemon.kotlinnetworking.feature.lastmatch.detail.DetailLastMatchPresenter
import com.example.junemon.kotlinnetworking.feature.lastmatch.detail.DetailLastMatchView
...
class DetailLastMatchActivityTest {

    @Mock
    lateinit var mView: DetailLastMatchView
    @Mock
    ...
    fun setUp() {
        ...
        presenter = DetailLastMatchPresenter(mView)
        database = DatabaseOpenHelper(RuntimeEnvironment.application)
        data = MainModelLastMatch.Event()
    }
